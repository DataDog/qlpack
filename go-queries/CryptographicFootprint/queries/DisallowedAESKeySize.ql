...
select sink, "Detected AES key from " + sink.getNode().getFile().getRelativePath() + " where the size of this key should be at least 16 bytes (128 bits)"